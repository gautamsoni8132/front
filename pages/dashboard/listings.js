...
function dashboard() {
    ...
    return (
        <>
            <Head>
                <title>Seller Dashboard- become a online seller in india | Flicart Seller Hub</title>
            ...
            <div onClick={hideDropmenu} className={styles.dashboardMain} >
                <h1>3 ways to get started</h1>
                <div className={styles.secondNav}>
                    <ul>
                        <Link href="#" style={{ "textDecoration": "none", "margin": "auto 20px" }}><li>SEARCH FLICART CATALOG AND LIST</li></Link>
                        <Link href="#addproduct" style={{ "textDecoration": "none", "margin": "auto 20px" }}><li>ADD A NEW PRODUCT</li></Link>
                        <Link href="#upload" style={{ "textDecoration": "none", "margin": "auto 20px" }}><li>UPLOAD VIA EXCEL</li></Link>
                    </ul>
                </div>
            </div>

            <div onClick={hideDropmenu} className={styles.detailInfo} style={{ "overFlowY": dashboardScroll ? "scroll" : "hidden" }}>
                <div className={styles.tittle}>
                    ...
                    <div className={styles.headInfo}>
                        <h2>SEARCH FLICART CATALOG AND LIST - Quicker Way</h2>
                        <h4>Check if your product is already listed on Flicart. If YES, you can reuse the cataloge details to create your listing.</h4>
                        <div className={styles.firstInput}>
                            <input type="text" placeholder='Search by Brand,FSN, Flicart Product URL ' />
                ...
                <div className={styles.tittle} id='addproduct'>
                    <div >
                        <h3 className={styles.count}>2</h3>
                    </div>
                    <div className={styles.headInfo}>
                        <h2>ADD A NEW PRODUCT</h2>
                        <h4>Have a product that has not yet been listed on Flicart? List it using a simple single listing flow.</h4>
                        <div className={styles.secondInput}>
                          <Link href="/dashboard/single">  <button>Add a single Listing</button></Link>
                        </div>
                ...
                <div className={styles.tittle} id='upload'>
                    <div >
                        <h3 className={styles.count} >3</h3>
                    </div>
                    <div className={styles.headInfo}>
                        <h2>UPLOAD VIA EXCEL</h2>
                        <h4>Have multiple products to add? Use an handy excel template here.</h4>
                        <div className={styles.secondInput}>
                            <button>Add Bulk Listing</button>
                        </div>
