...
function dashboard() {
    ...
    const toggleFunction = (ele) => {
        ...
        if(ele==1){
            ...
            if(value ==true){ setMenutoggle({...menutoggle,[ele]:!value}); setArrow({
                1: "/down.png",
                2: "/down.png",
                3: "/down.png",
                4: "/down.png",
            ...
            <div onClick={hideDropmenu} className={styles.detailInfo} style={{ "overFlowY": dashboardScroll ? "scroll" : "hidden" }}>
                ...
                <div className={styles.tittle} id='addproduct'>
                    ...
                    <div className={styles.headInfo}>
                        ...
                        <h4>Have a product that has not yet been listed on Flipkart? List it using a simple single listing flow.</h4>
                        <div className={styles.secondInput}>
                            <button>Add a single Listing</button>
                        </div>
