        ...
        <>
            ...
            <div className={styles.feesDiv}>
                ...
                <div className={styles.headerSection}>
                    ...
                    <h4>
                        With the most competitive rate card in the industry, transparent delivery charges based on the weight and dimensions of your products and a small fixed fee, selling on Flicart is highly cost-efficient.
                    </h4>
                </div>
                <br /> <hr /><br /><br />

                <div className={styles.mainSection}>
                    <h2>FLICART'S MARKETPLACE FEE STRUCTURE</h2>
                    ...
                    <div className={styles.mainSectionTop}>
                        ...
                        <div className={styles.feeInfo}>
                            ...
                            <h3>Fixed fee</h3>
                            <h5>
                                A small fee that Flicart charges on all transactions
                            </h5>
            ...
            <div className={styles.fulfilmentTypes}>
                ...
                <div className={styles.infoSectionFlex}>
                    ...
                    <div className={styles.fulfilmentInfo}>
                        ...
                        <h3>
                            Smart Fulfillment is a program wherein you get help from Flicart for systematically arranging your warehouse, easily maintaining your inventory and getting it smoothly delivered to your customer via...
                        </h3>
                        <h4>Know More</h4>
                    </div>
                    <div className={styles.fulfilmentInfo}>
                        <img width="40px" height="40px" src="/startup.png" alt="startup" />
                        <h3>Flicart Fulfilment</h3>
                        <h3>
                            At Flicart, we help you have maximum returns with minimum investment. That’s why the Flicart Fulfilment service offers you the use of our state-of-the-art fulfillment centers at very low costs. You ...
                        </h3>
                        <h4>Know More</h4>
                    </div>
                </div>
