...
export default function SignUp() {
    ...
    return (
        <>
            <Head>
                <title>SignUp- Sell online| Flicart Seller Hub</title>
            ...
            <div style={{ "display": signUp ? "block" : "none" }}>
                ...
                <div className={styles.navBar}>
                    <div className={styles.logos}>
                        <img width='35px'  src="/logoPic.png" alt="logo" />
                ...
                <div className={styles.formsection}>
                    <div className={styles.main}>
                        ...
                        <div className={styles.formMain} style={{ "display": mobileEmailSection ? "block" : "none" }} >
                            ...
                            <h2>What are you looking to sell on Flicart?</h2>
                            <br />
                            ...
                            <h2 style={{ "display": firstH2 ? "block" : "none" }}>GSTIN is required to sell products on Flicart. You can also share it in the final step.</h2>
                            ...
                            <h2 style={{ "display": secondH2 ? "block" : "none" }}>PAN is required to sell books on Flicart. You can also share it in the final step.</h2>

                            <br />
                            <div className={styles.registrationDiv}>
                                <h5>By continuing, I agree to Flicart’s <a href="#">Terms of Use</a>  & <a href="#">Privacy Policy</a> </h5>
                                <br />
                        ...
                        <div className={styles.detailShowCase}>
                            ...
                            <div className={styles.testy}>
                                <div className={styles.imagetesty}>
                                    <img width="57px" height="57px" src="/user1.png" alt="logo" />
                                </div>

                                <div className={styles.comment}>
                                    <h5>
                                        Starting with 1, Flicart helped me expand to 6 categories with 5x growth year on year!
                                    </h5>
                                    <h6>
                    ...
                    <div className={styles.flexWrap}>
                        ...
                        <div className={styles.flexSize}>
                            ...
                            <div className={styles.infoSection}>
                                ...
                                <p>Our Dedicated managers will help your business on Flicart</p>
                            </div>
                            ...
                            <div className={styles.infoSection}>
                                ...
                                <p>Download our Flicart Seller App to manage your business anywhere, anytime</p>
                            </div>
