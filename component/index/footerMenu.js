    ...
    return (
        <>
            ...
            <div className={styles.footerMenuMain}>
                <h1>Popular categories to sell online in India</h1>
                <br />
                <div className={styles.footerMenuDetail}>
                    <ul>
            ...
            <div className={styles.sellOn}>
                ...
                <h3>
                    ...
                    Our seamless registration process will take up only ten minutes of your time. All you need to do is fill in a few important details and you are good to go. So, sign up now and commence your e-commerce journey with Flicart Seller Hub!
                </h3>
            </div>
        </>
    );
